...
export class BoletoComponent {
  asientos = stryMutAct_9fa48("210") ? ["Stryker was here"] : (stryCov_9fa48("210"), []);
  ...
  obtenerListaSeleccionados() {
    if (stryMutAct_9fa48("211")) {
      ...
      stryCov_9fa48("211");
      this.asientosService.asientosSeleccionados$.subscribe(stryMutAct_9fa48("212") ? () => undefined : (stryCov_9fa48("212"), data => this.asientos = data));
    }
  }
