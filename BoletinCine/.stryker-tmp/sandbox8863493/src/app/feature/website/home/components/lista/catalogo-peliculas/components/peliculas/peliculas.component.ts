...
export class PeliculasComponent implements OnInit {
  peliculas: Pelicula[] = stryMutAct_9fa48("282") ? ["Stryker was here"] : (stryCov_9fa48("282"), []);
  idPelicula: string;
  ...
  obtenerPeliculas() {
    if (stryMutAct_9fa48("284")) {
      ...
      stryCov_9fa48("284");
      return this.peliculasService.obtenerListado().subscribe(stryMutAct_9fa48("285") ? () => undefined : (stryCov_9fa48("285"), data => this.peliculas = data));
    }
  }
}