...
public class Cliente {
    ...
    public static Cliente reconstruir(String nombre, String email, String contrasena, String documentoIdentidad, Membresia tipoMembresia){
        ...
        return new Cliente(nombre, email, contrasena, documentoIdentidad, tipoMembresia);
    }
