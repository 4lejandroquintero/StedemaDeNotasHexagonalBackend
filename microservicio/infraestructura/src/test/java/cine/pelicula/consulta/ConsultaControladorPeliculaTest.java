...
class ConsultaControladorPeliculaTest {
    @Autowired
    private MockMvc mockMvc;


    @Test
    void seObtieneListadoDePeliculas() throws Exception{
    ...
    @Test
    void seObtienePeliculaPorIDNumero1() throws Exception{
        mockMvc.perform(get("/pelicula/1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
    }
}
